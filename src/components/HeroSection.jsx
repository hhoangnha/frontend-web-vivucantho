            ...
            <div>
              <form class="flex items-center">
                ...
                <button
                  style={{ height: 50 }}
                  type="submit"
                  class="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white dark:text-purple rounded-md bg-blue-700  border hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-slate-500 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  <svg
                    aria-hidden="true"
